...
using AI.structure.Common.Plugs.LogPlug;
using Newtonsoft.Json;
using System;
using System.Collections.Generic;
using System.Text;

namespace AI.structure.Common.Plugs.JWTPlug
{
    /// <summary>
    /// 
    /// </summary>
    public class JWTPlug
    {
        ...
        static string ClientType = "AI.structure_PC_System";
        ...
        public static ResultMo<SysUserJwtPayloadMo> ValidJwtToken()
        {
            ...
            try
            {
                var token = AI.structure.Common.Authrization.MemberShiper.AppAuthorize?.Token;
