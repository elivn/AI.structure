...
namespace ConsoleTest
{
    class Program
    {
        ...
        public static async Task GetRedis()
        {
            ...
            dct.Add("123", tModel);
            dct.Add("234", tModel);
            AI.structure.Common.Plugs.CachePlug.StackRedisPlug.Instance.Set("Bearer 123@@", tModel, TimeSpan.FromMinutes(5));
            AI.structure.Common.Plugs.CachePlug.StackRedisPlug.Instance.Set("test2", dct, TimeSpan.FromMinutes(5));
            var result6 = AI.structure.Common.Plugs.CachePlug.StackRedisPlug.Instance.Get<Dictionary<string, EventThreshodMo>>("test2");
            Console.WriteLine(result6);
           
            var result = AI.structure.Common.Plugs.CachePlug.StackRedisPlug.Instance.Get<EventThreshodMo>("test2");
