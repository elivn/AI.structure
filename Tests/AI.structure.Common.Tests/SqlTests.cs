...
using AI.structure.Common.ComModels;
using AI.structure.Common.ComUtils;
using AI.structure.OrmPlug.SqlServer;
using AI.structure.CachePlug.Redis;
using AI.structure.Common.Plugs.CachePlug;
using System.Text;
...
namespace AI.structure.Common.Tests
{
    ...
    public class SqlTests : BaseTests
    {
        ...
        public async Task TestSearchFeature()
        {
            ...
            string signature = AI.structure.Common.Encrypt.HMACSHA.EncryptBase64(builder.ToString(), "apisecretXXXXXXXXXXXXXXXXXXXXXXX", null, "SHA256");
        ...
        public async Task PostTest2Batch()
        {
            ...
            stuPhysicalConditionRecord.ParentAbilityClassifyId = "AbilityClassify-00163E02237D-AI.structure1_Server_1-20200612170924892-1410016";
            stuPhysicalConditionRecord.ClassId = "Class-AI.structure.ksj.Service(1)-0000000000w-Class-00008";
            stuPhysicalConditionRecord.Content2 = "Describe";
            stuPhysicalConditionRecord.SchoolId = "School-00E04C2C4E57-AI.structure.ksj.Service(1)-20200903105505700-4234699";
            stuPhysicalConditionRecord.CreateBy = "SysUser-00E04C2C4E57-AI.structure.ksj.Service(1)-20200901190412905-1112687";
    ...
    public class SchoolEnvironmentRecordRep : BaseSqlServerRep<SchoolEnvironmentRecordRep, SchoolEnvironmentRecordMo>
    {
        ...
        {
            m_writeConnectionString = "Server=120.24.30.132;Database=AI.structure;Uid=AI.structure;Pwd=123@AI.structure.com";
            m_readeConnectionString = "Server=120.24.30.132;Database=AI.structure;Uid=AI.structure;Pwd=123@AI.structure.com";
